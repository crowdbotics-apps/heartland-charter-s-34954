...
## Project Structure
    ...
    ├── heartland_charter_s_34954  # Django project configurations
...
1. Clone this repo and `cd heartland_charter_s_34954`
...
2. Clone this repo and `cd heartland_charter_s_34954`
